...
from vjepa.diagnose.energy_maniskill import energies, pad7, sphere_dirs
...
def main():
    ...
    ap.add_argument("--ckpt", default="checkpoints/predictor_ft.pt")
    a = ap.parse_args()
    ...
    np.savez("results/eval_finetuned.npz", pretrained=p, finetuned=f)
