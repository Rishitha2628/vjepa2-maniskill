...
from vjepa.plan.grasp_cost import GraspScorer
from vjepa.plan.plan_grasp import cem_grasp
...
def main():
    ...
    np.savez("results/subgoal_plan.npz", grasp=np.array([r[0] for r in rows], float),
