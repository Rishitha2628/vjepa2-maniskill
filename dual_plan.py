...
import loader
import record
from hier_plan import choose_direction
...
def main():
    ...
    ap.add_argument("--kp-base", default="keypoint_near.pt")
    ap.add_argument("--kp-wrist", default="keypoint_wrist.pt")
    a = ap.parse_args()
    ...
    np.savez("dual_plan.npz", grasp=np.array([r[0] for r in rows], float),
